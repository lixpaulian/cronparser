...
![GitHub License](https://img.shields.io/github/license/lixpaulian/cronparser)
...
## Dependencies
The library depends very lightly on the __trace__ functionality found in the µOS++ package (https://github.com/micro-os-plus/micro-os-plus-iii), but this can be easily replaced.
